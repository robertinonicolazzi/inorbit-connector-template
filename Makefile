...
bump:
	...
	git commit -m "Bump flowcore-connector version: $${old_version} → $${new_version}"; \
	git tag -a "flowcore-connector-v$${new_version}" -m "Bump flowcore-connector version: $${old_version} → $${new_version}"; \
