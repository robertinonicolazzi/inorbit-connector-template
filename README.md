...
This connector implementation is based on the official publicly available FLOWCore API specifications available on the FLOWCore support portal. For detailed API documentation and reference materials, please refer to:
...
```bash
source config/.env && flowcore-connector -c config/my_fleet.yaml
```
